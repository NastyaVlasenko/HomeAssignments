...
public:
    ...
    {
        std::cout<<"Method transform from class Transformers"<<std::endl;
    }

    virtual void openfire() const
    {
        std::cout<<"Method openfire from class Transformers"<<std::endl;
    }

    virtual void ultra() const
    {
        std::cout<<"Method ultra from class Transformers"<<std::endl;
    }
