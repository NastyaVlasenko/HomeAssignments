...
TEST (Transformers, operator_test)
{
    std::ostringstream os;
    os<<testbot;
    ASSERT_EQ(os.str(), "Optimus General 5");
}
...
TEST (Avtobot, operator_test)
{
    std::ostringstream os;
    os<<testbot;
    ASSERT_EQ(os.str(), "Optimus General 5 10");
}
...
TEST (Decepticon, operator_test)
{
    std::ostringstream os;
    os<<testbot;
    ASSERT_EQ(os.str(), "Megatron Boss 7 9");
}
...
TEST (Dinobot, operator_test)
{
    std::ostringstream os;
    os<<testbot;
    ASSERT_EQ(os.str(), "Grimlock Leader 8 Dinosaur");
}
